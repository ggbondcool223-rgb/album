...
class MusicEditView extends GetView<MusicEditLogic> {
  const MusicEditView({super.key});
...
extension MusicEditViewExtensions on MusicEditView {
  Widget _buildPhotoSection() {
    return GetBuilder<MusicEditLogic>(id: 'photo',builder: (_) {
    return Container(
      padding: EdgeInsets.all(16.w),
      decoration: BoxDecoration(
